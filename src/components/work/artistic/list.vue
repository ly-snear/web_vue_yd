  ...
  <div class="h-panel">
    <div class="h-panel-body">
      <Table :datas="table.datas">
        ...
        <TableItem title="证书" prop="name"></TableItem>
        <TableItem title="状态">
  ...
  <Modal v-model="open.score" type="drawer-right">
    <div class="model-right">
      ...
      <Form ref="form" labelPosition="left">
        ...
        <FormItem label="证书" readonly>
          {{form.name}}
          <div class="cert-image">
            <Qiniu className="cert-image" type="image" data-type="url" v-model="form.cert"></Qiniu>
          </div>
        </FormItem>
